import{w as e,s as t,t as i,v as o,M as a,y as r,R as s,i as n,r as c,a as l,x as w,z as d,e as u,o as p,h as m,d as h,j as v,B as g,E as f,O as b,C as y,D as x,k,A as C,T as S,F as R,b as N,g as O}from"./DSU1xoRW.js";import{c as T,n as A,r as W,o as $,U as E}from"./CTK6zgtV.js";import"./BArbQupS.js";const P=t({message:"",open:!1,triggerRect:{width:0,height:0,top:0,left:0},variant:"shade"}),I=e({state:P,subscribe:e=>o(P,(()=>e(P))),subscribeKey:(e,t)=>i(P,e,t),showTooltip({message:e,triggerRect:t,variant:i}){P.open=!0,P.message=e,P.triggerRect=t,P.variant=i},hide(){P.open=!1,P.message="",P.triggerRect={width:0,height:0,top:0,left:0}}}),j={isUnsupportedChainView:()=>"UnsupportedChain"===s.state.view||"SwitchNetwork"===s.state.view&&s.state.history.includes("UnsupportedChain"),async safeClose(){if(this.isUnsupportedChainView())return void a.shake();await r.isSIWXCloseDisabled()?a.shake():a.close()}},D=n`
  :host {
    display: block;
